...
if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO user (nama, id_level, username, email, password) VALUES ('$nama','$id_level','$username','$email','$password')");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE user SET nama='$nama',id_level='$id_level',username='$username',email='$email',password='$password' WHERE id='$id'");
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="id_level" id="" class="form-control">
                                                        ...
                                                        <?php while ($resultLevel = mysqli_fetch_assoc($dataLevel)) : ?>
                                                            <option value="<?= $resultLevel['id'] ?>">
                                                                <?= $resultLevel['nama_level'] ?>
                                                            </option>
                                                        <?php endwhile ?>
                                                    </select>
                                                </div>
